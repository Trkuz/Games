...
text1 = font1.render(str(points_gained), False, (255,255,255))
textRect1 = text1.get_rect()
textRect1.center = (500, 50)


font2 = pygame.font.Font("font.ttf", 120)
text2 = font2.render("GAME OVER", False, (255,255,255))
...
while True:
    ...
    if game_active:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                if touching:
                    point = pygame.Rect(random.randint(1, 49) * cell_size, random.randint(1, 39) * cell_size, cell_size,cell_size)
                    points_gained += 1
                    text1 = font1.render(str(points_gained), True, (255, 255, 255))
                    textRect1 = text1.get_rect()
                    textRect1.center = (500, 50)
        ...
        text3 = font2.render(f"score: {str(points_gained)}", False, (255, 255, 255))
